...
k = 2
chosen_params = {"RegressaoLogistica_OneVsAll":np.zeros((num_features,10)), "RegressaoLogistica_Multiclasse":np.zeros((num_features,10))}
block_len = int(num_samples/k)
methods = {"RegressaoLogistica_Multiclasse":multi_log_reg_} # "RegressaoLogistica_OneVsAll":log_reg_
for m in methods:
